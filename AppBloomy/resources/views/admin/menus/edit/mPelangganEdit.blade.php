    ...
    <div class="card">
        <div class="card-body">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('mPelanggan.bloomy') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{ route('mPelangganTambah.bloomy') }}">Tambah Data</a>
                    </li>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "{{ route('prosesEditPelanggan.bloomy', $data['id_user']) }}",
            type: 'GET',
