        ...
        <div class="col-lg-8 d-flex align-items-strech">
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">
                                ...
                                {{-- <a href="{{ route('mWisata.bloomy') }}">Kembali</a> --}}
                            </h5>
                            <label>
                                Sejak :
                                {{ \Carbon\Carbon::parse($data['wisata']->tgl_input)->format('d F Y') }}
                            </label>
                        </div>
                        <div>
                    ...
                    <img src="/storage/admin/fotoWisata/{{ $data['wisata']->foto_usaha }}" alt="Foto" width="620"
                        height="650">
                </div>
            </div>
        </div>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-9 fw-semibold">
                                {{ $data['wisata']->kategori->kategori }}</h5>
                            <div class="row align-items-center">
                                <div class="col-12">
                                    <label class="fw-semibold">Deskripsi : </label>
                                    <p class="mb-0">{{ $data['wisata']->keterangan }}</p>
                                    <hr>
                                    <a
                                        href="https://maps.google.com/maps?q={{ urlencode($data['wisata']->lokasi) }}&t=&z=13&ie=UTF8&iwloc=&output=embed">
                                        {{ $data['wisata']->lokasi }}
                                    </a>
                                </div>
                            </div>
