        ...
        <div class="card-body">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('mPelangganTambah.bloomy') }}">Tambah Data</a></li>
                </ol>
            </nav>
...
<script>
    $(document).ready(function() {
        ...
        function loadUsers(page) {
            $.ajax({
                url: "{{ route('tampilPelanggan.admin.bloomy') }}?page=" + page,
                type: 'GET',
                success: function(response) {
                    if (response.success) {
                        ...
                        for (var i = 0; i < users.length; i++) {
                            ...
                            html += '<td>';
                            html += '<a href="/Dashboard/Admin/mPelanggan/Edit/' + users[i]
                                .id_user +
                                '" class="btn btn-sm btn-outline-primary me-1">Edit</a>';
                            html += '<a href="/api/prosesHapusPelanggan/' + users[i].id_user +
                                '" class="btn btn-sm btn-outline-danger" onclick="return confirm(\'Anda yakin ingin menghapus pelanggan ini?\')">Hapus</a>';
                            html += '</td>';
                            html += '</tr>';
                        }
