...
<section>
    <div class="row row-cols-1 mb-5 row-cols-md-2 g-4 d-flex justify-content-center align-items-center">
        ...
        <div class="col" style="width: 25rem;">
            <div class="card custom-rounded">
                <img src={{url('./assets/images/backgrounds/paket2.png')}} class="card-img-top custom-rounded" alt="...">
                <div class="card-body">
                    <div class="content">
    ...
    <div class="card1 mb-1" style="max-width: 100%;">
        <div class="row g-10">
            <div class="container-fluid d-flex justify-content-center align-items-center full-height mb-4 col-md-5">
                <img src={{url('./assets/images/backgrounds/grouping.png')}} class="img-fluid max-vh-250 max-vw-350 mt-auto p-5 img-group" alt="...">
            </div>
            <div class="col-md-6">
                <div class="card-body">
