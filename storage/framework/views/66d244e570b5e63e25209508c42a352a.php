...
<body>
                ...
                <div class="card shadow-3 px-5" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <p>
                                Belum memiliki akun? <a href="<?php echo e(route('registrasi.admin.bloomy')); ?>" class="text-dark text-decoration-underline">Daftar sekarang</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- <div id="login-box">
        ...
        <div class="right">
            ...
            <a href="<?php echo e(route('registrasi.admin.bloomy')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\BloomyApp-master\AppBloomy\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>